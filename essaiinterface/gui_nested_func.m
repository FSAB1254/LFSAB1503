...
handles(5)= uicontrol ( 'style' , 'edit' ,'units','normalized', 'position', [0.25,0.9,0.1,0.05] , 'string' , '0' );
uicontrol ( 'style' , ' text' , 'units','normalized', 'position', [0.05,0.9,0.2,0.05] , 'string' , 'Quantité de NH3 voulue (T)' );

% Création du bouton "Température de la réaction"
handles(5)= uicontrol ( 'style' , 'edit' ,'units','normalized', 'position', [0.5,0.9,0.1,0.05] , 'string' , '0' );
uicontrol ( 'style' , ' text' , 'units','normalized', 'position', [0.4,0.9,0.1,0.05] , 'string' , 'Température(K)' );
