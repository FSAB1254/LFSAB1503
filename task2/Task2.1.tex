...
Pour déterminer l'influence de ces paramètres à la sortie de notre dernier réacteur, il faut établir un tableau d'avancement de notre réaction et appliquer la loi des gaz parfaits pour faire apparaître nos paramètres.
...
avec a et b respectivement le nombre de moles initiales de \ce{N2} et \ce{H2}, $\xi$ le degré d'avancement, $\chi_i$ et $a_i$ respectivement la fractions molaire et l'activité correspondante au composé $i$. 
\\

Nous pouvons récrire la pression totale à l'équilibre par la loi des gaz parfaits : $$ p_{eq} = \frac{n_{eq}RT}{V} = \frac{(a+b-2\xi)RT}{V} $$
\\

Il faut maintenant ajuster la pression et la température à volume constant de manière à ce que  $Q_r <$ K (à cette même tempréature) pour que la réaction ait tendance à former du \ce{NH3}.

\[ Q_r= \frac{{(\chi_\ce{NH3} p_{tot})}^2}{(\chi_\ce{N2} p_{tot}) \cdot {(\chi_\ce{H2} p_{tot})}^3} \]

Notre outile de gestion nous indique que pour 1500 tonnes/jour d'ammoniac, a=1529.1 moles/s et b=509.7 moles/s avec $p_{eq}$= 26 bar et T=1000 K.
